...
for(i in 1:length(faithful$eruptions)){
  numerator <- numerator + ((faithful$eruptions[i]-mean(faithful$eruptions))*(faithful$waiting[i]-mean(faithful$waiting)))
  denominator_x <- denominator_x + (faithful$eruptions[i]-mean(faithful$eruptions))^2
  denominator_y <- denominator_y + (faithful$waiting[i]-mean(faithful$waiting))^2
}
